...
//     <>
//       <Navbar
//         className={` mx-auto max-w-screen px-4 py-2 rounded-none sticky top-0 z-50 shadow-none border-none
...
//               <SiStylelint />
//               <animated.span style={firstTextStyles}>Style</animated.span>
//               <animated.span style={secondTextStyles} className="bg-yellow-500 rounded">Swap</animated.span>
//             </div>
//           </Link>
...
//             <Button variant="outlined" size="sm" color="blue-gray" fullWidth>Log In</Button>
