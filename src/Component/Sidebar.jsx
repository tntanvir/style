...
//                         {userdata?.user_type === 'seller' || userdata?.user_type !== 'admin' && userdata?.user_type !== 'admin' && <li className="p-2 bg-white text-blue-500 rounded-lg mt-2 cursor-pointer text-start hover:bg-blue-500 hover:text-white transition">
...
//                         <li className="p-2 bg-white text-blue-500 rounded-lg mt-2 cursor-pointer text-start hover:bg-blue-500 hover:text-white transition">
...
//                             </NavLink>
//                         </li>
//                         {userdata?.user_type !== 'buyer' || userdata?.user_type !== 'admin' && userdata?.user_type !== 'admin' && <li className="p-2 bg-white text-blue-500 rounded-lg mt-2 cursor-pointer text-start hover:bg-blue-500 hover:text-white transition">
                ...
                <div className="mb-8 text-center">
                    <p>
                        {userdata?.image ?
                            ...
                            :
                            <div className=''>
                                <div className='rounded-full w-32 h-32 mx-auto bg-blue-gray-300 animate-pulse mb-2'>

                                </div>
                                <h2 className=' mb-2 h-2 mx-auto bg-blue-gray-300 animate-pulse'>

                                </h2>
                                <h2 className=' mb-2 h-2 w-11/12 mx-auto bg-blue-gray-300 animate-pulse'>

                                </h2>
                                <h2 className=' mb-16 w-1/2 h-2 mx-auto bg-blue-gray-300 animate-pulse'>
